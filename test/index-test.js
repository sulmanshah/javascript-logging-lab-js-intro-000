...
describe('index', () => {
  ...
  it('calls console.error('error message coming through')', done => {
  ...
  it('calls console.log('this is a log message')', done => {
  ...
  it('calls console.warn('hey this is a warning')', done => {
